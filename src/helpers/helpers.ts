import { pathsBase } from "./constances";
...
export const getPageName = (pathname:string,isAuth:boolean) => {
  ...
  export const getFullChoosedDate = (choosedYear:number, choosedMonth:number, choosedDate:number,increaser:number)=>{
    // 2022-10-10
    return new Date(
  ...
  export const getFetchedTimeStamp=(date:string)=>{
